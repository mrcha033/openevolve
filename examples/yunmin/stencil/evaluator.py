...
def _set_baseline(baseline: dict) -> None:
    Baseline.THROUGHPUT_OPS_SEC = float(baseline.get("ops_per_sec", 1400.0))
    Baseline.P99_LATENCY_US = float(baseline.get("p99_latency_us", 1200.0))
