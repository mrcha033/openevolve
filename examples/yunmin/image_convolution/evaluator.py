...
EXPERIMENT_NAME = "image_convolution"
...
def _set_baseline(baseline: dict) -> None:
    ...
    Baseline.P99_LATENCY_US = float(baseline.get("p99_latency_us", 100000.0))
...
def evaluate(program_path: str) -> dict:
    ...
    try:
        ...
        response = {
            ...
            "mpix_per_sec": metrics.get("mpix_per_sec", 0.0),
        }
